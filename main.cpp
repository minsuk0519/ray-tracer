...
// Write the image as a HDR image.
#define STB_IMAGE_WRITE_IMPLEMENTATION
#include "stb_image_write.h"
void WriteHdrImage(const std::string outName, const int width, const int height, Color* image)
{
    // Turn image from a 2D-bottom-up array of Vector3D to a top-down array of floats
    ...
    stbi_write_hdr(outName.c_str(), width, height, 3, data);
